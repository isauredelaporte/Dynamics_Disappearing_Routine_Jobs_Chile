...
Databases for the EPS can be downloaded here: https://previsionsocial.gob.cl/datos-estadisticos/condiciones-bases-de-datos-eps/

This do file also uses the Excel file with name "ISCO_class_2004"

If you find any mistake, please inform us at isauredelaporte@gmail.com and wernerhp87@gmail.com

If you use this do file please cite our paper: The Dynamics of Disappearing Routine Jobs in Chile: An Analysis of the Link Between Deroutinisation and Informality
...
* Based on Mihaylov_Tijdens 2019 and CASEN 2015 - baseline allocation used in the paper
...
*/ | occ_2digit==32 | occ_2digit==33 
replace occ_class=2 if occ_2digit==34 | occ_2digit==41 | occ_2digit==42 | occ_2digit==52 
replace occ_class=3 if occ_2digit==73 | occ_2digit==74 | occ_2digit==81 | occ_2digit==82  
replace occ_class=4 if occ_2digit==51 | occ_2digit==61 | occ_2digit==62 | occ_2digit==71 | occ_2digit==72 | occ_2digit==83 | occ_2digit==91 | occ_2digit==92 | occ_2digit==93
*

/* 
* Allocation based on majority of votes - See Table A.2 - Classification of occupational groups - Class majority
g occ_class=1 if occ_2digit==11 | occ_2digit==12 | occ_2digit==13 | occ_2digit==21 | occ_2digit==22 | occ_2digit==23 | occ_2digit==24 | occ_2digit==31 /*
*/ | occ_2digit==32 | occ_2digit==33 
replace occ_class=2 if occ_2digit==34 | occ_2digit==41 | occ_2digit==42 
replace occ_class=3 if occ_2digit==73 | occ_2digit==74 | occ_2digit==81 | occ_2digit==82  
replace occ_class=4 if occ_2digit==51 | occ_2digit==52 | occ_2digit==61 | occ_2digit==62 | occ_2digit==71 | occ_2digit==72 | occ_2digit==83 | occ_2digit==91 | occ_2digit==92 | occ_2digit==93
*
*/ 

/*
* Allocation based on Lewandowski P., Keister R., Hardy W., Górka S., 2020. Ageing of routine jobs in Europe. Economic Systems, 44 (4), 100816, 10.1016/j.ecosys.2020.100816
g occ_class=1 if occ_2digit==11 | occ_2digit==12 | occ_2digit==13 | occ_2digit==21 | occ_2digit==22 | occ_2digit==23 | occ_2digit==24 | occ_2digit==31 /*
*/ | occ_2digit==32 | occ_2digit==33
replace occ_class=2 if occ_2digit==34 | occ_2digit==41 | occ_2digit==42 | occ_2digit==52
replace occ_class=3 if occ_2digit==72 | occ_2digit==74 | occ_2digit==81 | occ_2digit==82  
replace occ_class=4 if occ_2digit==51 | occ_2digit==62 | occ_2digit==71 | occ_2digit==73 | occ_2digit==83 | occ_2digit==91 | occ_2digit==92 | occ_2digit==61 | occ_2digit==93
*/
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88", replace 
...
save "$data_clean\transition_matrix_1980_2015_2_digits_isco88", replace 
...
*** Group 1: Male, Low, 15-29
*** Group 2: Male, Low, 30+
*** Group 3: Male , Medium, 15-29
*** Group 4: Male, Medium, 30+
*** Group 5: Male, High, 15-29
*** Group 6: Male, High, 30+
*** Group 7: Female, Low, 15-29
*** Group 8: Female, Low, 30+
*** Group 9: Female, Medium, 15-29
*** Group 10: Female, Medium, 30+
*** Group 11: Female, High, 15-29
*** Group 12: Female, High, 30+

/*
To run this exercise generate all the dta databases for all the demographic groups. Then, use the Excel file "transitions_1980_2015_2_digit_88"
and create 12 copies, one for each demographic group. Then copy and paste the content of the dta databases in the corresponding Excel file, using the tab
with name "base". 

After this use the following Excel files:

counterfactual_demonstration_law_of_motion_with_demographic_groups - copy the tab "law of motion" in the corresponding Excel files and tab

counterfactual_demographic_group_shares_constant - copy the tab "law of motion with av rates" in the corresponding Excel files and tab -  this is to get Table 8 in our paper

counterfactual_demographic_group_transition_rate_constant - copy the tab "law of motion counter dist" in the corresponding Excel files and tab -  this is to get Table 9 in our paper

*/

*** Group 1: Male, Low, 15_29***********************************************************************

use "$data_clean\data_chile_paper_1980_2015_2_digits_isco88", replace 
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88_m_l_15_29", replace 
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88_m_l_30", replace 
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88_m_m_15_29", replace 
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88_m_m_30", replace 
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88_m_h_15_29", replace 
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88_m_h_30", replace 
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88_f_l_15_29", replace 
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88_f_l_30", replace 
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88_f_m_15_29", replace 
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88_f_m_30", replace 
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88_f_h_15_29", replace 
...
save "$data_clean\data_chile_paper_1980_2015_2_digits_isco88_f_h_30", replace 
