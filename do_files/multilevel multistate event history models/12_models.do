...
* Descriptives
stptime, by(type)
stptime if time_NRC==1, by(type)
stptime if time_NRC==8, by(type)
stptime if type==1
...
streg ib1.agegroup ib1.order ib1.time_since_NRC ib1.education#ib5.type#ib1.time_NRC, dist(exponential) cluster(folio_n20)
...
* Descriptives
* event: 1 NRC, 2 RC, 3 NRM, 4 unemp, 5 inactive
stptime, by(type)
stptime if time_RC==1, by(type)
stptime if time_RC==8, by(type)
stptime if type==1
...
* event: 1 NRC, 2 RC, 3 NRM, 4 unemp, 5 inactive
stptime, by(type)
stptime if time_RM==1, by(type)
stptime if time_RM==8, by(type)
stptime if type==1
...
replace agegroup_dummy = 1 if agegroup==3
replace agegroup_dummy = 2 if agegroup>3
streg ib1.sex ib1.time_since_RM ib1.agegroup_dummy#ib5.type#ib1.time_RM, dist(exponential) cluster(folio_n20)
...
* Descriptives
* event: 1 NRC, 2 RC, 3 RM, 4 unemp, 5 inactive
stptime, by(type)
stptime if time_NRM==1, by(type)
stptime if time_NRM==8, by(type)
stptime if type==1
...
replace agegroup_dummy = 2 if agegroup>3
tab agegroup_dummy,m
streg ib1.sex ib1.time_since_NRM ib1.agegroup_dummy#ib5.type#ib1.time_NRM, dist(exponential) cluster(folio_n20)
...
* event: 1 NRC, 2 RC, 3 NRM, 4 unemp, 5 inactive
stptime, by(type)
stptime if time_Outofemp==1, by(type)
stptime if time_Outofemp==8, by(type)
stptime if type==1
...
replace agegroup_dummy = 2 if agegroup>3
tab agegroup_dummy,m
streg ib1.sex ib1.time_since_outofemp ib1.agegroup_dummy#ib1.type#ib1.time_outofemp, dist(exponential) cluster(folio_n20)
...
replace agegroup_dummy = 2 if agegroup>3
tab agegroup_dummy,m
streg ib1.sex ib1.time_since_NRC ib1.agegroup_dummy#ib5.type#ib1.time_NRC, dist(exponential) cluster(folio_n20)
...
replace agegroup_dummy = 2 if agegroup>3
tab agegroup_dummy,m
streg ib1.sex ib1.time_since_RC ib1.agegroup_dummy#ib5.type#ib1.time_RC, dist(exponential) cluster(folio_n20)
...
keep if previous_occ==1 | previous_occ==2 | previous_occ==3 | previous_occ==4
...
keep if previous_occ==5 | previous_occ==6 | previous_occ==7 | previous_occ==8
